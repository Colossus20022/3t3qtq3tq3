...
local RequiredDistance, Typing, Running, ServiceConnections, Animation, OriginalSensitivity = 150, false, false, {}
...
getgenv().ExunysDeveloperAimbot = {
	...
	Settings = {
		...
		TriggerKey = Enum.UserInputType.MouseButton3,
		Toggle = false
	},
...
local GetClosestPlayer = function()
	...
	if not Environment.Locked then
		RequiredDistance = Environment.FOVSettings.Enabled and Environment.FOVSettings.Radius or 150
